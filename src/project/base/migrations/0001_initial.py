    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('played_moves', models.JSONField(blank=True, default={'Paper': 0, 'Rock': 0, 'Scissors': 0}, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opponent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='opponent_rounds', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['timestamp'],
            },
