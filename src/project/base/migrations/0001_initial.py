    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('played_moves', models.JSONField(blank=True, default=dict, null=True)),
                ('faced_moves', models.JSONField(blank=True, default=dict, null=True)),
                ('most_played_move', models.CharField(blank=True, choices=[('Rock', 'Rock'), ('Paper', 'Paper'), ('Scissors', 'Scissors')], default='', max_length=64, null=True)),
                ('most_faced_move', models.CharField(blank=True, choices=[('Rock', 'Rock'), ('Paper', 'Paper'), ('Scissors', 'Scissors')], default='', max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='host_rounds', to=settings.AUTH_USER_MODEL)),
                ('opponent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opponent_rounds', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opponent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='joined_rooms', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-updated', '-created'],
            },
